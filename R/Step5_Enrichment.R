...
KEGGEnrichPlotPanel <- function(sampleData, enrichDB = "kegg", pvalcutoff = 0.05, IDtype = 1, cateIdx = 1){
  ...
  IDTrans <- function(db,idtype,cpdlist){
    ...
    #load("D:/Code/Rpackage/mmeaseR/data/tableName_all.RData")

    tableName_all <- function() {
      utils::data(list="tableName_all", package="mmeaseR")
      get("tableName_all", envir = .GlobalEnv)
    }

    tableName_all <- tableName_all()
...
Enrichment <- function(param){
  ...
  #load("D:/Code/Rpackage/mmeaseR/data/sql_all.RData")


  sql_all <- function() {
    utils::data(list="sql_all", package="mmeaseR")
...
EnrichData <- function() {
  utils::data(list="EnrichData", package="mmeaseR")
